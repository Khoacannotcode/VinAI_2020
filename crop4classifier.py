...
def get_path(number):
  path = "/home/VinBigData_ChestXray/data_classify/4_10_11_12_classifier_ver1/4_10_11_12_classifier_ver1/{}".format(number)
...
class_4 = get_path(4)
print("Length class 4: ", len(class_4))
class_4_labels = ['4']*len(class_4)

class_10 = get_path(10)
print("Length class 10: ", len(class_10))
class_10_labels = ['10']*len(class_10)

class_11 = get_path(11)
print("Length class 11: ", len(class_11))
class_11_labels = ['11']*len(class_11)

class_12 = get_path(12)
print("Length class 12: ", len(class_12))
class_12_labels = ['12']*len(class_12)

labels = class_4_labels + class_10_labels + class_11_labels + class_12_labels 
image_links = class_4 + class_10 + class_11 + class_12 
...
model = EfficientNetB5(input_shape=(1024, 1024, 3),
                    include_top = False,
                    weights='imagenet')
...
# 
# print("Saved model {}".format("B6_100epoch.h5"))

# model_json = model.to_json()
# with open("/home/VinBigData_ChestXray/data_classify/EfficientNetB6_classification.json", "w") as json_file:
